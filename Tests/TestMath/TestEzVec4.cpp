...
bool TestEzVec4(const std::string& vTest) {
    ...
    else IfTestExist(TestEzVec4Set<uint32_t>);
    else IfTestExist(TestEzVec4Set<int64_t>);
    else IfTestExist(TestEzVec4Set<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Increment<uint32_t>);
    else IfTestExist(TestEzVec4Increment<int64_t>);
    else IfTestExist(TestEzVec4Increment<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Decrement<uint32_t>);
    else IfTestExist(TestEzVec4Decrement<int64_t>);
    else IfTestExist(TestEzVec4Decrement<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Sum<uint32_t>);
    else IfTestExist(TestEzVec4Sum<int64_t>);
    else IfTestExist(TestEzVec4Sum<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Equality<uint32_t>);
    else IfTestExist(TestEzVec4Equality<int64_t>);
    else IfTestExist(TestEzVec4Equality<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Addition<uint32_t>);
    else IfTestExist(TestEzVec4Addition<int64_t>);
    else IfTestExist(TestEzVec4Addition<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Subtraction<uint32_t>);
    else IfTestExist(TestEzVec4Subtraction<int64_t>);
    else IfTestExist(TestEzVec4Subtraction<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Multiplication<uint32_t>);
    else IfTestExist(TestEzVec4Multiplication<int64_t>);
    else IfTestExist(TestEzVec4Multiplication<uint64_t>);
    ...
    else IfTestExist(TestEzVec4Division<uint32_t>);
    else IfTestExist(TestEzVec4Division<int64_t>);
    else IfTestExist(TestEzVec4Division<uint64_t>);
